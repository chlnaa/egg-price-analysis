...
| 데이터                     | 출처                           | 수집 방법     | 기간      |
| -------------------------- | ------------------------------ | ------------- | --------- |
| 달걀 소매가격              | KAMIS (한국농수산식품유통공사) | XLS 직접 수집 | 2016~2025 |
| 양계용배합사료 PPI         | ECOS (한국은행 경제통계시스템)                | CSV 직접 수집 | 2016~2025 |
| 산업용전력 PPI             | ECOS (한국은행 경제통계시스템)                | CSV 직접 수집 | 2016~2025 |
| 달걀 생산자·소비자물가지수 | ECOS (한국은행 경제통계시스템)                | CSV 직접 수집 | 2016~2025 |
...
본 프로젝트는 아래 공공 데이터를 활용했습니다.

- [한국은행 경제통계시스템 ECOS](https://ecos.bok.or.kr)
- [한국농수산식품유통공사](https://www.kamis.or.kr/)

데이터는 비상업적 학습 및 포트폴리오 목적으로 사용했습니다.
